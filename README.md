...
![alt text](https://github.com/Asheeshkrsharma/IAS/blob/master/images/act3-1.png "Control result of the pendulum system for initial position 2 m"){:height="24px" width="48px"}
